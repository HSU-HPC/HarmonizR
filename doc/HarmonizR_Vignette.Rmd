---
title: "HarmonizR Vignette"
author: "Simon Schlumbohm"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
    %\VignetteIndexEntry{HarmonizR Vignette}
...
as well as example data) can be installed directly from GitHub via the command `devtools::install_github("HSU-HPC/HarmonizR/HarmonizR@HarmonizR-1.1")`, while
...
Here, we pass the created dataframes directly. Alternatively, a path to the
